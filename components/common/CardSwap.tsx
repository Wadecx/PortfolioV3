...
const CardSwap: React.FC<CardSwapProps> = ({
  ...
  return (
    <div
      ref={container}
      className="relative perspective-[900px] overflow-visible mx-auto max-[768px]:scale-[0.75] max-[768px]:-translate-x-8 max-[480px]:scale-[0.65] max-[480px]:-translate-x-12"
      style={{ width, height }}
    >
      {rendered}
    </div>
